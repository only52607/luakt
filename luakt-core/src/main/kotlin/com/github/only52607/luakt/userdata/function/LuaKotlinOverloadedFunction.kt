...
fun Collection<KFunction<*>>.joinAsLuaKotlinOverloadedFunction(
    valueMapper: ValueMapper,
    parameterBuilder: ParameterBuilder = ParameterBuilder.Default(valueMapper),
    functionCaller: FunctionCaller = FunctionCaller.Blocking
) = LuaKotlinOverloadedFunction(map { LuaKotlinFunction(it, valueMapper, parameterBuilder, functionCaller) })