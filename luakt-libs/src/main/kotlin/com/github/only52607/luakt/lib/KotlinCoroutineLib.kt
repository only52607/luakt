...
import com.github.only52607.luakt.dsl.luaFunctionOf
...
@Suppress("unused")
class KotlinCoroutineLib(private val coroutineScope: CoroutineScope, private val valueMapper: ValueMapper) :
